...
Public Class bClearance
    ...
    Private Sub List()
        'SHOW ITS DATA
        strsql = "SELECT Resident_No, Last_Name, First_Name, MI, Block_No, Address, DOB, POB, Sex, Age, Civil_Status, Occupation, Household, Status, Registered_Voters, Purpose, Remarks FROM tbl_residents"
    ...
    Private Sub Report()
        ...
        Try
            ...
            Else
                ...
                cmd.Parameters.AddWithValue("@Act", "Printed Clearance")
                cmd.ExecuteNonQuery()
                connect.Close()
    ...
    Private Sub UpdateReq()
        'UPDATE REQUIREMENTS LIKE PURPOSE
        ...
        ElseIf MessageBox.Show("Update this Requirement?", "Update", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = vbYes Then
            strsql = "UPDATE tbl_residents SET Purpose = '" & txtPurp.Text & "' WHERE Last_Name = '" & txtLast.Text & "'"
            cmd = New MySqlCommand(strsql, connect)
            ...
            Try
                ...
                If adapter.UpdateCommand.ExecuteNonQuery() > 0 Then
                    txtClear()
                    List()
                    MessageBox.Show("Clearance Requirement Updated Successfully", "Update", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    ...
                    cmd.Parameters.AddWithValue("@Time", DateTime.Now.ToLongTimeString)
                    cmd.Parameters.AddWithValue("@Date", DateTime.Now.ToShortDateString)
                    cmd.Parameters.AddWithValue("@Act", "Updated Clearance")
                    cmd.ExecuteNonQuery()
                    connect.Close()
    ...
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        ...
        Try
            ...
            Dim Purpose As String = row.Cells(15).Value.ToString
